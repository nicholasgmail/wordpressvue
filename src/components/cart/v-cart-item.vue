<template>
  <b-card class="flex-row mb-3 py-2" no-body border-variant="info">
    ...
    <b-col cols="5" sm="7" class="p-0">
      <b-card-text class="font-size-14 font-weight-bold">{{cart_item_data.name}}</b-card-text>
      <b-card-title class="font-size-12 text-muted m-0"><span v-pre>Артикул:</span> {{cart_item_data.sku}}</b-card-title>
      <hr class="my-2" />
    ...
    <b-col cols="4" sm="3">
      ...
      <b-input-group size="sm" class="mb-2">
        ...
        <b-form-input class="text-center" type="number" min="0" :value="cart_item_data.quantity"></b-form-input>
